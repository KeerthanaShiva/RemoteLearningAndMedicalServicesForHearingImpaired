...
.show {display:block;}
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Remote Learning</a>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a class="nav-link js-scroll-trigger" href="http://localhost/ayush/login.php">USER/PATIENTS</a>
    <a href="doctorlogin.php">CONSULTANT</a>
    <a href="http://localhost/ayush/entlogin.php">MEDICAL SERVICE</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1 class="brand-heading"> REMOTE LEARNING</h1>
                <p class="intro-text">LEARN INDIAN SIGN LANGUAGE 
                <br>FOR PEOPLE WITH HEARING DISABILITY</p>
      ...
      <div class="container">
        <div class="col-lg-8 mx-auto">
          ...
          <a href="">USER/PATIENTS</a>
		   <p>USER CAN LEARN INDIAN SIGN LANGUAGE, TAKE APPOINTMENT ANY WHERE,SEARCH NEARBY HOSPITAL,CLINIC,etc AND ALSO PRACTICE TEST </p>
		   <a href="">DOCTOR</a>
