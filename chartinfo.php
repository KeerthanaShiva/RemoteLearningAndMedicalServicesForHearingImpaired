...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="">REMOTE LEARNING</a>
    ...
    <main class="app-content">
     <div class="app-title">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Number of Treatment done by Month</h3>
       ...
       <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Number of Registration</h3>
            <div class="embed-responsive embed-responsive-16by9">
